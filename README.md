...
**Blog App** is crafted with the perfect blend of Ruby on Rails, React, and CSS. Experience the ultimate platform for expressing your thoughts, connecting with like-minded individuals, and fostering engaging discussions. With my user-friendly interface, posting, commenting, and liking become seamless and intuitive, allowing you to effortlessly share your ideas and insights. Whether you're a seasoned writer or a passionate reader, my blog app offers a dynamic and immersive environment to explore, engage, and be inspired. Join us today and embark on a journey of creativity, connection, and community.
...
```sh
  cd my-folder
  git clone git@github.com:CaptainBawa/Blog-App.git
```
...
Feel free to check the [issues page](https://github.com/CaptainBawa/Blog-App/issues).
...
This project is [MIT](https://github.com/CaptainBawa/Blog-App/blob/development/LICENSE) licensed.
